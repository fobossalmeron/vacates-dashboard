...
const warnings = [
  { site: "monitor", message: "WebFetch falló para Exteriores (403), Alianza Francesa .edu.mx (timeout) y FCO (URL no procesable); los tres se validaron correctamente con navegador y sus snapshots quedaron actualizados al 2026-07-21." },
